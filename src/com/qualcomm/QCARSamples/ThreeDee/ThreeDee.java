...
public class ThreeDee extends Activity
{
    ...
    private static final String NATIVE_LIB_SAMPLE = "ThreeDee";    
    ...
    // Our renderer:
    private ThreeDeeRenderer mRenderer;
    ...
    {   
        ...
        {
            QCAR.setInitParameters(ThreeDee.this, mQCARFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(ThreeDee.this).create();
    ...
    {
        DebugLog.LOGD("ThreeDee::onCreate");
   ...
   /** Called when the activity will start interacting with the user.*/
    ...
    {
        DebugLog.LOGD("ThreeDee::onResume");
        super.onResume();
    ...
    {
        DebugLog.LOGD("ThreeDee::onPause");
        super.onPause();
    ...
    {
        DebugLog.LOGD("ThreeDee::onDestroy");
        super.onDestroy();
     ...
     * access by ThreeDee::onResume() and InitQCARTask::onPostExecute(). */
    ...
    {        
        ...
        mRenderer = new ThreeDeeRenderer();
